...
const Article = (props) => {
  return (
    <div>
      ...
      <Jumbotron fluid>
        <Container fluid>
          <h1 className="display-3">Hospedagem</h1>
          <p className="lead">
          A Foco Cloud Computing Tecnologia evoluiu, como uma empresa genuinamente brasileira, e expandiu ao longo dos seus 20 anos, focada em soluções para a nuvem. Hoje atende milhares de beneficiários, guias processadas e milhões de contas faturadas, em todo o país.
